...
const fr = {
  ...
  'plan.cancel': 'Annuler',
  'plan.hint': 'Au confirmer, les dates s’ajoutent dans Calendrier. Touchez Ajouter si iPhone le demande.',
...
const pt: Record<MsgKey, string> = {
  ...
  'plan.hint': 'Ao confirmar, as datas são adicionadas ao Calendário. Toque em Adicionar se o iPhone pedir.',
