...
const fr = {
  ...
  'plan.subtitleShort': 'Pose et deux rappels à ajouter dans Calendrier.',
  'plan.tabPose': 'Pose',
  'plan.tabR1': 'Rappel 1',
  'plan.tabR2': 'Rappel 2',
  ...
  'plan.cancel': 'Annuler',
  'plan.hint': 'Confirmez, puis touchez Ajouter dans Calendrier. Sur iPhone, choisissez Ajouter.',
...
const pt: Record<MsgKey, string> = {
  ...
  'plan.subtitleShort': 'Aplicação e dois lembretes a adicionar ao Calendário.',
  ...
  'plan.hint': 'Confirme e depois toque em Adicionar no Calendário. No iPhone, escolha Adicionar.',
