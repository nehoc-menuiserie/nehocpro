...
const fr = {
  ...
  'plan.cancel': 'Annuler',
  'plan.hint': 'Au confirmer, Calendrier s’ouvre. Touchez Ajouter pour enregistrer la pose et les deux rappels.',
...
const pt: Record<MsgKey, string> = {
  ...
  'plan.hint': 'Ao confirmar, o Calendário abre. Toque em Adicionar para guardar a aplicação e os dois lembretes.',
