...
const fr = {
  ...
  'plan.subtitle': 'Date de pose et deux rappels (date et heure).',
  'plan.subtitleShort': 'Pose et deux rappels. Safari demandera d’autoriser l’ajout dans Calendrier.',
  'plan.tabPose': 'Pose',
  'plan.tabR1': 'Rappel 1',
  'plan.tabR2': 'Rappel 2',
  ...
  'plan.cancel': 'Annuler',
  'plan.hint': 'Confirmez : Safari demandera d’autoriser, puis touchez Ajouter dans Calendrier.',
  'plan.addCalendar': 'Ajouter au calendrier du téléphone',
  'plan.savedPhone': 'Safari demande d’ajouter les dates. Touchez Autoriser, puis Ajouter.',
...
const pt: Record<MsgKey, string> = {
  ...
  'plan.subtitle': 'Data de aplicação e dois lembretes (data e hora).',
  'plan.subtitleShort': 'Aplicação e dois lembretes. O Safari pede autorização para adicionar ao Calendário.',
  ...
  'plan.hint': 'Confirme: o Safari pede autorização, depois toque em Adicionar no Calendário.',
  'plan.addCalendar': 'Adicionar ao calendário do telemóvel',
  'plan.savedPhone': 'O Safari pede para adicionar as datas. Toque em Permitir e depois em Adicionar.',
