...
const fr = {
  ...
  'home.searchOpen': 'Rechercher',
  'home.searchClose': 'Fermer la recherche',
  ...
  'report.csvProdevis': 'Exporter le CSV pour ProDevis',
  'report.csvHint': 'Ouvrez le CSV dans ProDevis ou Excel (séparateur point-virgule). Une ligne = une menuiserie, prix à remplir dans ProDevis.',
  ...
  'plan.title': 'Date de pose',
  'plan.subtitle': 'Indiquez le jour de la pose sur ce chantier.',
  'plan.subtitleShort': 'Choisissez la date de pose.',
  'plan.tabPose': 'Pose',
  'plan.tabR1': 'Rappel 1',
  'plan.tabR2': 'Rappel 2',
  ...
  'plan.needAll': 'Renseignez la date de pose.',
  'plan.confirm': 'Confirmer',
  'plan.cancel': 'Annuler',
  'plan.hint': 'Confirmez la date de pose.',
  'plan.addCalendar': 'Ajouter au calendrier du téléphone',
  'plan.savedPhone': 'Date de pose enregistrée.',
...
const pt: Record<MsgKey, string> = {
  ...
  'home.searchOpen': 'Pesquisar',
  'home.searchClose': 'Fechar a pesquisa',
  ...
  'report.csvProdevis': 'Exportar o CSV para o ProDevis',
  'report.csvHint': 'Abra o CSV no ProDevis ou no Excel (separador ponto e vírgula). Uma linha = um vão, preços a preencher no ProDevis.',
  ...
  'plan.title': 'Data da aplicação',
  'plan.subtitle': 'Indique o dia da aplicação neste estaleiro.',
  'plan.subtitleShort': 'Escolha a data da aplicação.',
  ...
  'plan.needAll': 'Preencha a data da aplicação.',
  'plan.confirm': 'Confirmar',
  'plan.cancel': 'Cancelar',
  'plan.hint': 'Confirme a data da aplicação.',
  'plan.addCalendar': 'Adicionar ao calendário do telemóvel',
  'plan.savedPhone': 'Data da aplicação guardada.',
